...
<div class="features view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            <th><?= __('Flag All') ?></th>
            <td><?= $feature->flag_all ? __('Yes') : __('No'); ?></td>
        </tr>
        <tr>
            <th><?= __('Flag Bar') ?></th>
            <td><?= $feature->flag_bar ? __('Yes') : __('No'); ?></td>
        </tr>
        <tr>
            <th><?= __('Flag Restaurant') ?></th>
            <td><?= $feature->flag_restaurant ? __('Yes') : __('No'); ?></td>
        </tr>
        <tr>
            <th><?= __('Flag Hotel') ?></th>
            <td><?= $feature->flag_hotel ? __('Yes') : __('No'); ?></td>
        </tr>
        <tr>
            <th><?= __('Flag Store') ?></th>
            <td><?= $feature->flag_store ? __('Yes') : __('No'); ?></td>
        </tr>
        <tr>
            <th><?= __('Flag Mall') ?></th>
            <td><?= $feature->flag_mall ? __('Yes') : __('No'); ?></td>
        </tr>
    </table>
    <div class="related">
        <h4><?= __('Related Venues') ?></h4>
        <?php if (!empty($feature->venues)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($feature->venues as $venues): ?>
            <tr>
                <td><?= h($venues->id) ?></td>
                <td><?= h($venues->name) ?></td>
                <td><?= h($venues->slug) ?></td>
